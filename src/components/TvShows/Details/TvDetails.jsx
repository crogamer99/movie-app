...
export default function TvDetails(tvID) {

    const [show, setShow] = useState([])
    const params = useParams();
    const url = `https://api.themoviedb.org/3/tv/${params.tvID}?api_key=${API_KEY}`;
        ...
        <div>
            ...
            <div className="custom-container">
                ...
                <div className="holder">
                    ...
                    <Link to={`/rate/${show.id}`} className="custom-button">Rate this Tv Show</Link>
                </div>
